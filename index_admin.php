...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlLogin = "SELECT * FROM karyawan WHERE username = '$username' AND password = '$password'";
    ...
    if ($resultLogin->num_rows == 1) {
        ...
        $_SESSION['user_role'] = $row['jabatan'];

        // Alihkan ke halaman sesuai jabatan
        if ($row['jabatan'] == 'Owner') {
            header("Location: owner/index.php");
        } elseif ($row['jabatan'] == 'Admin') {
            header("Location: admin/index.php");
        } elseif ($row['jabatan'] == 'Karyawan') {

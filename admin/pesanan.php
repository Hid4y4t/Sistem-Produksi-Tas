                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                        ...
                                        <i class='bi bi-bag-plus me-1'></i> Tambah Pesanan
                                    </button>
                                    <div class="modal fade" id="verticalycentered" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"><i class='bi bi-bag-plus me-1'></i>Tambah Pesanan</h5>
                                    ...
                                    if ($resultPesanan->num_rows > 0) {
                                        ...
                                        while ($rowPesanan = $resultPesanan->fetch_assoc()) {
                                            echo "<tr>
                                                    ...
                                                    <td>
                                                        <a href='edit_pesanan.php?id=".$rowPesanan['id'] . "' class='btn btn-outline-primary'><i class='bi bi-pencil'></i> Edit</a>
                                                        <a href='hapus_pesanan.php?id=".$rowPesanan['id'] . "' class='btn btn-outline-danger' onclick='return confirm(\"Apakah Anda yakin ingin menghapus pesanan ini?\")'><i class='bi bi-trash'></i> Hapus</a>
                                                    </td>
                                                </tr>";
                                        }
...
if ($resultProsesSelesai->num_rows > 0) {
    ...
    while ($rowProsesSelesai = $resultProsesSelesai->fetch_assoc()) {
        echo "<tr>
                ...
                <td><button ' class='btn btn-outline-danger' onclick=\"hapusData(" . $rowProsesSelesai['id'] . ")\">Hapus</button></td>
            </tr>";
    }
    echo "</table>";
...
?>
    ...
    function hapusData(id) {
        if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
            // Kirim permintaan penghapusan ke skrip PHP

                                                ...
                                                <div class="modal-body">
                                                    <form action="proses_tambah_pelanggan.php" method="post">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <button type="submit" class="btn btn-outline-primary">  <i class="bi bi-plus me-1"></i> Tambah pelanggan</button>
                                                            </div>
                                                        </div>
                                    ...
                                    if ($resultPelanggan->num_rows > 0) {
                                        ...
                                        while ($rowPelanggan = $resultPelanggan->fetch_assoc()) {
                                            echo "<tr>
                                                    ...
                                                    <td>
                                                        <a href='edit_pelanggan.php?id=" . $rowPelanggan['id_pelanggan'] . "' class='btn btn-outline-success'><i class='bi bi-arrow-clockwise me-1'></i> Edit</a>
                                                        <a href='proses_hapus_pelanggan.php?id=" . $rowPelanggan['id_pelanggan'] . "' class='btn btn-outline-danger' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'><i class='bi bi-trash me-1'></i> Hapus</a>
                                                    </td>
                                                </tr>";
                                        }

                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="" method="post">
                                                        ...
                                                        <input class="btn btn-outline-warning"type="submit" name="proses_selesai"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <input type="hidden" value="<?php echo $lastSelesaiEksekusi; ?>"  name="selesai_eksekusi" >

                                        <input class="btn btn-outline-primary" type="submit" value="Update Data">
                                    </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="" method="post">
                                                        ...
                                                        <input class="btn btn-outline-danger" type="submit" name="move_to_antrian"
